...
(function () {
  ...
  var workshop = {
    ...
    tentativeSchedule: [
      ...
      { time: '9:55 – 10:10', title: 'Oral 4: An Empirical Analysis of Continual Learning for Heterogeneous Medical Visual Question Answering', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=2XRlUBE9zD', authors: 'Mai A. Shaaban, Tausifa Jan Saleem, Alaa Mohamed, Dilnaz Utemissova, Ufaq Khan, Mohammad Yaqub' },
      { time: '10:10 – 10:25', title: 'Oral 5: Multimodal Fusion for Domain-Incremental Continual Learning in 3D Medical Imaging', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xeA25gEbO5', authors: 'Paraskevi Antonia Theofilou, Paraskevi Tzouveli, Stefanos D. Kollias' },
      { time: '10:25 – 10:40', title: 'Oral 6: How Resilient are Foundation Segmentation Models to Noisy Ultrasound Artifacts? A Multi-Dataset Benchmark Across Prompts, Noise Types, and Severity Levels', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=95wCZ1t73R', authors: 'Tran Quoc Duy Nguyen, Minh Quan Nguyen, Trung Thanh Nguyen, Thanh-Huy Nguyen, Thien Nguyen, Xiaofeng Liu, Ulas Bagci' },
      { time: '10:40 – 11:30', title: 'Lunch break', duration: '50 min', type: 'break' },
      { time: '11:30 – 12:15', title: 'Invited Talk 2 (incl. Q&A)', duration: '45 min', type: 'invited' },
      { time: '12:15 – 12:30', title: 'Oral 7: Learning to Reason Over Physician Corrections: An Interactive Agentic Framework for 3D Tumor Segmentation', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xWvFq4UXt6', authors: 'Nourhan Bayasi, Fereshteh Yousefirizi, Arman Rahmim' }
    ],
