...
(function () {
  ...
  var workshop = {
    ...
    tentativeSchedule: [
      ...
      { time: '8:05 – 8:20', title: 'Oral 1: Investigating Test-Time Adaptation of Convolutional Neural Networks for Medical Image Analysis under Distribution Shifts', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=nnwkA90wtm' },
      { time: '8:20 – 8:35', title: 'Oral 2: Continual Merging with Test-Time Adaptation for Whole-Slide Image Analysis', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=pTQCy30UBd' },
      ...
      { time: '9:55 – 10:10', title: 'Oral 4: An Empirical Analysis of Continual Learning for Heterogeneous Medical Visual Question Answering', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=2XRlUBE9zD' },
      { time: '10:10 – 10:25', title: 'Oral 5: Multimodal Fusion for Domain-Incremental Continual Learning in 3D Medical Imaging', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xeA25gEbO5' },
      { time: '10:25 – 10:40', title: 'Oral 6: How Resilient are Foundation Segmentation Models to Noisy Ultrasound Artifacts? A Multi-Dataset Benchmark Across Prompts, Noise Types, and Severity Levels', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=95wCZ1t73R' },
      ...
      { time: '12:15 – 12:30', title: 'Oral 7: Learning to Reason Over Physician Corrections: An Interactive Agentic Framework for 3D Tumor Segmentation', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xWvFq4UXt6' }
    ],
