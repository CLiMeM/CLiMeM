...
(function () {
  ...
  var workshop = {
    ...
    importantDates: [
      ...
      { label: 'CLiMeM workshop day', date: 'Sunday, September 27, 2026 · 8:00 AM–12:30 PM · Londrezs 1 (G)', status: 'announced' },
    ...
    tentativeSchedule: [
      ...
      { time: '8:05 – 8:20', title: 'Oral 1: Investigating Test-Time Adaptation of Convolutional Neural Networks for Medical Image Analysis under Distribution Shifts', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=nnwkA90wtm', authors: 'Patricia Stöhr, Michael Götz, Timo Ropinski, Daniel Santak Wolf' },
      { time: '8:20 – 8:35', title: 'Oral 2: Continual Merging with Test-Time Adaptation for Whole-Slide Image Analysis', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=pTQCy30UBd', authors: 'Duc-Thanh Le, Doanh C. Bui, Maï K. Nguyen, Khang Nguyen' },
      { time: '8:35 – 8:45', title: 'Short break', duration: '10 min', type: 'break' },
      { time: '8:45 – 9:30', title: 'Invited Talk 1 (incl. Q&A)', duration: '45 min', type: 'invited' },
      { time: '9:30 – 9:45', title: 'Oral 3: Integrating Uncertainty and Latent Feature Diversity for Robust Memory Replay in Continual Medical Imaging Learning', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=LSx4EI3xs8', authors: 'Mathilde Dupouy, Yamil Vindas, Novia Putri Bahirah, Thibaut Dambry, Blaise Kévin Guépié, Douglas Teodoro, Philippe Delachartre' },
      { time: '9:45 – 10:00', title: 'Oral 4: An Empirical Analysis of Continual Learning for Heterogeneous Medical Visual Question Answering', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=2XRlUBE9zD', authors: 'Mai A. Shaaban, Tausifa Jan Saleem, Alaa Mohamed, Dilnaz Utemissova, Ufaq Khan, Mohammad Yaqub' },
      { time: '10:00 – 10:40', title: 'MICCAI-wide coffee break', duration: '40 min', type: 'break' },
      { time: '10:40 – 10:55', title: 'Oral 5: Multimodal Fusion for Domain-Incremental Continual Learning in 3D Medical Imaging', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xeA25gEbO5', authors: 'Paraskevi Antonia Theofilou, Paraskevi Tzouveli, Stefanos D. Kollias' },
      { time: '10:55 – 11:10', title: 'Oral 6: How Resilient are Foundation Segmentation Models to Noisy Ultrasound Artifacts? A Multi-Dataset Benchmark Across Prompts, Noise Types, and Severity Levels', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=95wCZ1t73R', authors: 'Tran Quoc Duy Nguyen, Minh Quan Nguyen, Trung Thanh Nguyen, Thanh-Huy Nguyen, Thien Nguyen, Xiaofeng Liu, Ulas Bagci' },
      { time: '11:10 – 11:20', title: 'Short break', duration: '10 min', type: 'break' },
      { time: '11:20 – 12:05', title: 'Invited Talk 2 (incl. Q&A)', duration: '45 min', type: 'invited' },
      { time: '12:05 – 12:20', title: 'Oral 7: Learning to Reason Over Physician Corrections: An Interactive Agentic Framework for 3D Tumor Segmentation', duration: '15 min', type: 'session', url: 'https://openreview.net/forum?id=xWvFq4UXt6', authors: 'Nourhan Bayasi, Fereshteh Yousefirizi, Arman Rahmim' },
      { time: '12:20 – 12:30', title: 'Closing', duration: '10 min', type: 'opening' }
    ],
    programIntro: 'CLiMeM will be held on <strong>Sunday, September 27, 2026</strong>, <strong>8:00 AM–12:30 PM</strong> (local time), room <strong>Londrezs 1 (G)</strong>, Strasbourg Convention Center, Strasbourg, France. The full session schedule is below.',
    ...
    cameraReadyInstructions: {
      ...
      steps: [
        { title: '1. Prepare your camera-ready PDF', items: ['Incorporate feedback from your reviewers where applicable.', 'Your main body may now extend up to <strong>8.5 pages</strong> (previously 8), plus up to <strong>2 pages for references</strong> (unchanged).', 'Keep the same MICCAI main conference paper format you used for your original submission.', '<span class="camera-ready-new">NEW</span> Save your final paper as: <code>CLiMeM_XXX.pdf</code> (where <code>XXX</code> is your paper ID, e.g., <code>CLiMeM_013.pdf</code>).', '<span class="camera-ready-new">NEW</span> If you have supplementary material, save it as a single PDF named <code>CLiMeM_XXX_supp.pdf</code>.', '<span class="camera-ready-new">NEW</span> Also prepare your manuscript source files:', '<strong>LaTeX:</strong> a zipped file with all .tex files, figures, .bib file, and any non-standard style files/fonts, named <code>CLiMeM_XXX_source.zip</code>', '<strong>Word:</strong> the source .docx file, named <code>CLiMeM_XXX_source.docx</code>'] },
        { title: '2. Complete and sign the License to Publish form', items: ['Download the <a href="SNCS_ProceedingsPaper_LTP_ST_SN_Switzerland.docx">License to Publish form</a>.', 'Fill in: paper title, full author list, and corresponding author. <strong>Do not edit any pre-filled fields.</strong>', 'Print and sign the form by hand (wet-ink signature), then scan or photograph it and convert it to PDF.', '<span class="camera-ready-new">NEW</span> Save it as: <code>CLiMeM_XXX_LTP.pdf</code> (e.g., <code>CLiMeM_013_LTP.pdf</code>).'] },
        { title: '3. Upload files on OpenReview', items: ['Log in to <a href="https://openreview.net/group?id=MICCAI.org/2026/Workshop/CLiMeM" target="_blank" rel="noopener">OpenReview</a> and go to your paper\'s page.', 'Click the blue <strong>Edit</strong> button in the top right corner.', 'From the dropdown, select <strong>camera-ready</strong>.', 'Upload your camera-ready PDF in the paper file field.', 'Upload your signed License to Publish form (PDF) in the designated field.', 'Click <strong>Submit</strong>.', '<span class="camera-ready-new">NEW</span> <strong>Note:</strong> your original submission plus the reviews and your responses to reviewers will remain publicly visible on OpenReview — only the camera-ready file itself stays hidden.'] },
        { title: '4. Registration reminder', items: ['At least one author must register for MICCAI 2026 and present the work in person in Strasbourg. Papers without a registered, presenting author may not appear in the final proceedings.'] },
        { title: '<span class="camera-ready-new">NEW</span> 5. Patent notice', items: ['An open-access version of all accepted CLiMeM papers will be made available on the MICCAI Society website no earlier than one week before the first day of the conference. If you intend to file a patent based on this work, please ensure all necessary filings are completed before that date.'] },
        { title: '<span class="camera-ready-new">NEW</span> 6. Springer Code of Conduct', items: ['Please review <a href="https://www.springernature.com/gp/authors/book-authors-code-of-conduct" target="_blank" rel="noopener">Springer Nature\'s Code of Conduct for Book Authors</a>, particularly the sections on <strong>Figures and Illustrations</strong> and <strong>Ethical Approval and Informed Consent</strong>, given CLiMeM\'s subject matter.'] }
      ],
